...
const databases = [
    ...
    },
    {
        ...
        references: ["https://www.sqlite.org/index.html"],
        category: "database"
    },
]
...
const orms = [
    {
        ...
        references: ["https://sequelize.org/"],
        category: "orm"
    },
]
...
const ui_ux = [
    {
        ...
        references: ["https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/HTML_basics"],
        category: "ui_ux"
    },
...
const third_party_apis = [
    {
        ...
        icon: "google_maps",
        description: "Amazon S3 is an object storage service that offers industry-leading scalability, data availability, security, and performance.",
        references: ["https://developers.google.com/maps"],
