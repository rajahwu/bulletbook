...
CREATE POLICY "Enable read access for all users" ON "public"."technology" FOR SELECT USING (true);
...
GRANT ALL ON TABLE "public"."technology" TO "anon";
GRANT ALL ON TABLE "public"."technology" TO "authenticated";
GRANT ALL ON TABLE "public"."technology" TO "service_role";
